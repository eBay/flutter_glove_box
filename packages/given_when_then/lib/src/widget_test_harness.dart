...
class WidgetTestWhen<T extends WidgetTestHarness> extends UnitTestWhen<T> {
  /// Creates the [WidgetTestWhen], which makes both the [WidgetTestHarness] and the [WidgetTester] available for use
  /// in test actions.
...
class WidgetTestThen<T extends WidgetTestHarness> extends UnitTestThen<T> {
  /// Creates the [WidgetTestThen], which makes both the [WidgetTestHarness] and the [WidgetTester] available for use
  /// in test actions.
