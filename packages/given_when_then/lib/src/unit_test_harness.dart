...
/// This function is intended to wrap your Unit tests so that you can access the [UnitTestGiven], [UnitTestWhen],
/// and [UnitTestWhen] to compose the test case. You will want to create some of your own test support code that is
...
/// extend this class and provide any dependencies you require. See [example_unit_test_support.dart] for a complete example
...
class UnitTestWhen<T> {
  /// Creates the [UnitTestWhen], which makes the [T] available to act on in tests.
